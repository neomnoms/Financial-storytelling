...
JSON_OUTPUT = "data/parsed/disney_flexible_flow_2024.json"
...
- Format your output as a list of labeled financial flows that can be visualized in a Sankey chart
...
{{
  ...
  "year": {year},
  "flow": [
    {{ "label": "Example Income", "amount": 40000000 }},
    {{ "label": "Example Expense", "amount": -10000000 }},
    {{ "label": "Net Profit", "amount": 30000000 }}
  ]
}}
```
...
def extract_json(response):
    try:
        # Extract clean JSON inside a markdown-style code block
...
if __name__ == "__main__":
    ...
    if structured_json:
        ...
        print(f"\n✅ AI-generated flow structure saved to {JSON_OUTPUT}")
    else:
